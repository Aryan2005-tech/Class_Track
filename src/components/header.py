...
def header_home():
    ...
    st.markdown(f"""
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; margin-bottom:30px; margin-top:30px;">
            ...
            <h1 style='text-align:center; color:white !important; text-shadow: 0 2px 15px rgba(0,0,0,0.2);'>SNAP<br>CLASS</h1>
        </div>
...
def header_dashboard():
    ...
    st.markdown(f"""
        <div style="display:flex; align-items:center; justify-content:center; gap:12px; margin-top:30px;">
            ...
            <h2 style='text-align:center; color:#4f46e5 !important; margin:0;'>SNAP<br>CLASS</h2>
        </div>
    """, unsafe_allow_html=True)    
